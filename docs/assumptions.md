...
| A-05-14 | Aceita para o desafio | O Compose mantém o simulador em contêiner separado; na Railway, o limite do plano exige co-localizar seu WSGI no contêiner do worker. | O gateway Playwright usa `127.0.0.1:8000`; o bind permite o healthcheck pela rede privada e não recebe domínio público. |
