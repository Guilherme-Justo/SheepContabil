...
MIDDLEWARE = [
    ...
    "core.identity.middleware.Friendly404Middleware",
]
...
AUTOMATION_QUEUED_STALE_AFTER_SECONDS = env.int(
    "AUTOMATION_QUEUED_STALE_AFTER_SECONDS",
    default=30 * 60,
)
AUTOMATION_RUNNING_STALE_AFTER_SECONDS = env.int(
    "AUTOMATION_RUNNING_STALE_AFTER_SECONDS",
    default=30 * 60,
)
AUTOMATION_RECONCILIATION_MAX_ATTEMPTS = env.int(
    "AUTOMATION_RECONCILIATION_MAX_ATTEMPTS",
    default=1,
)
...
SC20_MONTHLY_HOUR = env.int("SC20_MONTHLY_HOUR", default=8)
